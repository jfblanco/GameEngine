...
Mesh* MeshFactory::createCube(){
	...
	resu->vertexColors[0].x(0.0);resu->vertexColors[0].y(1.0);resu->vertexColors[0].z(0.0);
	resu->vertexColors[1].x(0.0);resu->vertexColors[1].y(1.0);resu->vertexColors[1].z(0.0);
	resu->vertexColors[2].x(0.0);resu->vertexColors[2].y(1.0);resu->vertexColors[2].z(0.0);
	resu->vertexColors[3].x(0.0);resu->vertexColors[3].y(1.0);resu->vertexColors[3].z(0.0);
	resu->vertexColors[4].x(0.0);resu->vertexColors[4].y(1.0);resu->vertexColors[4].z(0.0);
	resu->vertexColors[5].x(0.0);resu->vertexColors[5].y(1.0);resu->vertexColors[5].z(0.0);
	resu->vertexColors[6].x(0.0);resu->vertexColors[6].y(1.0);resu->vertexColors[6].z(0.0);
	resu->vertexColors[7].x(0.0);resu->vertexColors[7].y(1.0);resu->vertexColors[7].z(0.0);
